...
module Xooa
  module Api
    # Class to provide methods for connecting to Query Api
    class QueryApi
      ...
      def query(function_name, args, timeout = "4000")
        ...
        path = '/query/{fcn}'.sub('{' + 'fcn' + '}', function_name.to_s)
        ...
        if status_code == 200
          return Xooa::Response::QueryResponse.new(response['payload'])
