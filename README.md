...
Everyone interacting in the Xooa::Ruby::Sdk project’s codebases, issue trackers, chat rooms and mailing lists is expected to follow the [code of conduct](https://github.com/xooa/xooa-ruby-sdk/blob/master/CODE_OF_CONDUCT.md).
